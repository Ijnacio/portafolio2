...
export default function Footer() {
    const socialLinks = [
        ...
        {
            icon: Mail,
            href: "mailto:g.sobarzo@duocuc.cl", 
            label: "Email"
        }
    ];
                        ...
                        {socialLinks.map((social) => {
                            ...
                            return (
                                <a
                                    ...
                                    onMouseEnter={(e) => {
                                        e.currentTarget.style.boxShadow = "0 0 20px rgba(217, 70, 239, 0.5)";
                                    }}
                                    onMouseLeave={(e) => {
                                        e.currentTarget.style.boxShadow = "0 0 10px rgba(217, 70, 239, 0.2)";
                                    }}
                                    aria-label={social.label}
                                >
                                    <Icon className="w-5 h-5 text-lavender-gray group-hover:text-neon-magenta transition-colors" />
                                </a>
                            );
                        })}
                    </div>
